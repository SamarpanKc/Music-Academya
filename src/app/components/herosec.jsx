  ...
  return (
    <div className="main h-screen w-full flex flex-col gap-16 justify-center items-center">
      <div className="bg-hero bg-cover bg-center h-full w-full absolute">
        <motion.div 
          className="circle w-80 h-48 rounded-full relative -left-56 top-11 bg-red-500 blur-2xl opacity-50"
        ></motion.div>
        <motion.div
          animate={{
            rotate: 360,
          ...
          className="rectangle relative top-32 left-3/4 w-0 h-0 border-l-[150px] border-l-transparent border-r-[50px] border-r-transparent border-b-[150px] bg-gray-400 blur-2xl opacity-30"
        ></motion.div>
      </div>
      ...
      <div className="getStart flex px-60">
        <motion.button
          whileTap={{ scale: 0.9 }}
          className="bg-gray-300 px-12 py-4 cursor-pointer rounded-lg font-inter font-semibold text-xl text-black flex justify-center items-center gap-2 z-10"
        >
