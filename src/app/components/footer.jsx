...
return(
    <>
    <footer>
    <div class="bg-yellow-600 py-4 px-28 text-white font-inter">
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class=" flex flex-col gap-4 justify-center w-full xl:w-1/5  font-inter">
    ...
    <div class="bg-yellow-500 py-4 text-yellow-950">
      <div class="container mx-auto px-4">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-12 w-full text-center sm:w-auto sm:text-left">
