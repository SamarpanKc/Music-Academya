    ...
    <div className="bg-yellow-900 py-4 px-28 text-white font-inter">
      <div className="container px-4 mx-auto">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className=" flex flex-col gap-4 justify-center w-full xl:w-1/5  font-inter">
          <Link href={"./"} ><h1 className="font-kanit text-3xl text-white font-semibold">HMusic<span className="text-yellow-500">.</span></h1> </Link>
            <p className="text-justify">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta quam consequuntur est. Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam, deleniti.
            </p>
          </div>
